...
Ccnet.prototype.disable = function () {
  ...
  this._stopPolling()   // Fix: disable polling here
...
Ccnet.prototype._send = function (command) {
  ...
  setTimeout(() => {
    console.log("periodic _send(), POLLING_INTERVAL:", POLLING_INTERVAL)
...
Ccnet.prototype._startPolling = function () {
  ...
  this.pollingInterval = setInterval(() => {
    console.log("periodic POLL _startPolling(), POLLING_INTERVAL:", POLLING_INTERVAL)
