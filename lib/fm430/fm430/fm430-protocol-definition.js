...
const Fm430ProtocolDefinition = {
  ...
  '128DEF':{    // Code 128 - Restore Factory defaults
  ...
  'EA8CHK':{    // EAN-8 - Transmit Check Character On/Off
    ...
    'type': 'EAN-8',
    'argName': '',
    'argType': FM430DataTypes.TRANSMIT_CHECK_CHARACTER,
    'manualReference': 'p. 87'
  },
  ...
  'UPEDEF':{    // UPC-E - Restore Factory defaults
  ...
  'UPEPRE':{    // UPC-E - Transmit Preamble Character
    ...
    'type': 'UPC-E',
    'argName': '',
    'argType': FM430DataTypes.TRANSMIT_PREAMBLE_CHARACTER,
  ...
  'M25MIN':{    // No less than 4
    ...
    'name': 'Matrix2of5SetMinimumLength',
    'type': 'Matrix 2 of 5',
    'argName': 'minLength',
    'argType': FM430DataTypes.NUMBER,
  ...
  'M25MAX':{
    ...
    'name': 'Matrix2of5SetMaximumLength',
    'type': 'Matrix 2 of 5',
    'argName': 'maxLength',
    'argType': FM430DataTypes.NUMBER,
    'manualReference': 'p. 119'
  ...
  'CBADEF':{
    ...
    'name': 'CodabarRestoreFactoryDefaults',
  ...
  'CBAMIN':{
    'description': 'Codabar - Set the Minimum Length',
  ...
  'CBAMAX':{
    'description': 'Codabar - Set the Maximum Length',
  ...
  'CBACHK':{
    'description': 'Codabar - Check Character Verification',
  ...
  'CBATSC':{
    'description': 'Codabar - Start/Stop Character Enable/Disable',
  ...
  'CBASCF':{
    'description': 'Codabar - Start/Stop Character Type',
  ...
  'CHPMIN':{
    ...
    'name': 'ChinaPost25SetMinimumLength',
    'type': 'China Post 25',
    'argName': 'minLength',
    'argType': FM430DataTypes.NUMBER,
  ...
  'CHPMAX':{
    ...
    'name': 'ChinaPost25SetMaximumLength',
    'type': 'China Post 25',
    'argName': 'maxLength',
    'argType': FM430DataTypes.NUMBER,
    'manualReference': 'p. 135'
  ...
  'MSOCHK':{
    ...
    'type': 'MSI-Plessey',
    'argName': '',
    'argType': FM430DataTypes.MSI_PLESSEY_CHECK_CHARACTER_VERIFICATION,
  ...
  'AZTMUL':{
    ...
    'name': 'AztecCodeSetNumberOfBarcodes',
    'type': 'Aztec',
  ...
  'CID029':{
    'description': 'Modify MSI-Plessey Code ID',
    'name': 'ModifyMSIPlesseyCodeID',
    'type': 'Change ID',
    'argName': '',
    'argType': FM430DataTypes.BYTE,
    'maxLength': 2,
  ...
  'CID097':{
    'description': 'Modify USPS Intelligent Mail Code ID',
    'name': 'ModifyUSPSIntelligentMailCodeID',
    'type': 'Change ID',
    'argName': '',
    'argType': FM430DataTypes.BYTE,
    'maxLength': 2,
...
module.exports = {
  FM430Protocol: Fm430ProtocolDefinition
};
