...
FM430.prototype.load_incoming_hid_package = function (hid_package) {
  ...
  //console.log("load_incoming_hid_package: type(hid_package): " + utils.type(hid_package));
...
FM430.prototype.enqueue = function(action, fm430_package, result_callback, error_callback) {
  ...
  //console.log("enqueue: type(fm430_package): " + utils.type(fm430_package));
...
FM430.prototype.write_to_fm430 = function (fm430_package) {
  ...
  //console.log("write_to_fm430: type(fm430_package): " + utils.type(fm430_package));
  if(!this.deviceBusy) {
    this.deviceBusy = true;
