...
/* PACKAGE TYPES */
const PACKAGE_TYPE = {
  DATA_PACKAGE_QUEUE: 0x00,             // Part of a multiple series of data packages, to be assembled and then returned as a whole
  DATA_PACKAGE_END: 0x01,               // The last package in the series, when this is encountered, the whole is returned
  COMMAND_PACKAGE: 0x02                 // A command package, this is usually a ACK response after sending a command to the camera
};
...
const MSI_PLESSEY_CHECK_CHARACTER_VERIFICATION = {
  DISABLE: 0x30,
...
module.exports = {
  ...
  ISBN_FORMAT,
  MSI_PLESSEY_CHECK_CHARACTER_VERIFICATION,
