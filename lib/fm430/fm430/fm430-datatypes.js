...
const TRAMSMIT_CHECK_CHARACTER = {
  DO_NOT_TRANSMIT: 0x31, 
  TRANSMIT: 0x32
};

const TRAMSMIT_PREAMBLE_CHARACTER = {
  NO_PREAMBLE: 0x30, 
...
module.exports = {
  ...
  TRAMSMIT_CHECK_CHARACTER,
  TRAMSMIT_PREAMBLE_CHARACTER,
  CHARACTER_ENCODING,
  INVERSE_READING,
  TWIN_CODE,
  ILLUMINATION,
